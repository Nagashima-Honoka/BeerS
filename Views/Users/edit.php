...
$details = $user->more();
$selectComments = $user->selectComment();
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="comment_confirmation">
                                    <p class="kakomi"><?php if (!empty($selectComments["selectComment"]["text"])) { echo $selectComments["selectComment"]["text"] ;} ?></p>
                                    <div class="post_btn">
                                        <a href="edit_post.php?id=<?= $details['beer']['id'] ?>" class="btn btn-outline-success btn-sm" type="submit" name="comment" value="comment">編集</a>
                                    </div>
                                </div>
                            </div>
                        </div>
